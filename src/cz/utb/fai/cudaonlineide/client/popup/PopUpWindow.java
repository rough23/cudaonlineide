...
public class PopUpWindow {
     ...
     *
     * @param coiFolder Folder to add file.
     ...
     *
     * @param coiProject Project to add folder.
     ...
     *
     * @param coiWorkspace Workspace to add project.
     ...
     *
     * @param userWorkspacePath User work path for new workspace.
     ...
     *
     * @param workspaceFiles All user workspaces.
     ...
     *
     * @param coiFolder Folder to add uploaded file.
     ...
     *
     * @param coiObject Directory to extract ZIP.
     ...
     *
     * @param lineCount Line count of text.
